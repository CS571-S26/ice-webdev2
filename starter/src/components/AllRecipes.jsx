...
export default function AllRecipes(props) {
    ...
    useEffect(() => {
        ...
        fetch("https://cs571api.cs.wisc.edu/rest/s26/ice/pizza", {
            headers: {
        ...
        .then(data => {
            setPizza(data);
            console.log(Stopwatch.get(), "T: An update to pizza has been triggered!");
        })

        fetch("https://cs571api.cs.wisc.edu/rest/s26/ice/pasta", {
            headers: {
                "X-CS571-ID": CS571.getBadgerId()
            }
        })
        ...
        .then(data => {
            setPasta(data);
            console.log(Stopwatch.get(), "T: An update to pasta has been triggered!");
        })
        ...
        .then(data => {
            setChili(data);
            console.log(Stopwatch.get(), "T: An update to chili has been triggered!");
        })

...
export default function Recipe(props) {
    ...
    function handleLike() {
        ...
        console.log(Stopwatch.get(), `T: An update to the number of likes for ${props.name} recipe has been triggered!`);
    }

    useEffect(() => {
        if (likes > 0) { // remember this gets ran on mount and dependency change
